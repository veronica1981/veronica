        ...
        <table style="width: 100%"  cellspacing="0" cellpadding="3">
           ...
           <td colspan=4></td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="datatest1" class="useDatepicker" runat="server" Width="120px"></asp:TextBox></td>
                <td align="left">
            ...
            <td>
                <asp:TextBox ID="datatest2" class="useDatepicker" runat="server" Width="120px"></asp:TextBox></td>
            </tr>
            <tr>
