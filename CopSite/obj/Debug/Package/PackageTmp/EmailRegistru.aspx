<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="EmailRegistru" Title="Trimitere Email Registru" Codebehind="EmailRegistru.aspx.cs" %>
        ...
        <tr>
            ...
            <td style="width: 192px">
                <asp:Button ID="Button1" runat="server" BackColor="MediumSeaGreen" Font-Bold="True"
                    Font-Names="Arial" Font-Size="10pt" Text="Trimite email" OnClick="Button1_Click" /></td>
            <td>
            </td>
        </tr>
        <tr>
