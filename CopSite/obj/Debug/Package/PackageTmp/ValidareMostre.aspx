    ...
    <table style="width: 100%" border=0 cellspacing=2>
        <tr>
            ...
            <td style="height: 26px">
                <asp:TextBox ID="datatestare" CssClass="hasDatepicker" AutoPostBack="True" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
    ...
    <HeaderTemplate>
                ...
                <tr bgcolor="#00D269" class="heading">
                  ...
                  <ItemTemplate>
                    ...
                    <td style="height: 33px;">
                        <asp:Label ID="datat" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "datat") %>'  SkinID=blackv></asp:Label></td>
                    ...
                    <td style="height: 33px;" bgcolor=<%# (UMostre.VerificPh(Convert.ToString(DataBinder.Eval(Container.DataItem,"ph"))) == 1) ? "#ff0000" : "#00D269" %>>
                     ...
                     <td style="height: 33px;" bgcolor=<%# (UMostre.VerificUrea(Convert.ToString(DataBinder.Eval(Container.DataItem,"urea"))) == 1) ? "#ff0000" : "#00D269" %>>
