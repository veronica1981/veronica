...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:FormView ID="FormView1" runat="server" CellPadding="5" CellSpacing="5" DataSourceID="ObjectDataSource1" DataKeyNames="ID"
        DefaultMode="Edit" GridLines="Both" HeaderText="Detalii Mostra" OnItemInserted="FormView1_ItemInserted" OnItemInserting="FormView1_ItemInserting" 
        OnItemUpdated="FormView1_ItemUpdated" OnItemUpdating="FormView1_ItemUpdating" OnItemDeleted="FormView1_ItemDeleted" OnDataBound="FormView1_OnDataBound">
        <EditItemTemplate>
        ...
        <td><asp:TextBox ID="DataPrimiriiTextBox" runat="server" class="useDatepicker" Text='<%# Bind("DataPrimirii","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
         
            </td>
        <td class="heading" >Data prelevarii:</td>
        <td> <asp:TextBox ID="DataPrelevareTextBox" runat="server" class="useDatepicker" Text='<%# Bind("DataPrelevare","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
        ...
        <td><asp:TextBox ID="DataTestareTextBox" runat="server" class="useDatepicker" Text='<%# Bind("DataTestare","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
                     </td>
        <td class="heading" >Data testarii finale</td>
        <td> <asp:TextBox ID="DataTestareFinalaTextBox" runat="server" class="useDatepicker" Text='<%# Bind("DataTestareFinala","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
        ...
        <tr height=20px>
        <td class="heading" >Data primirii:</td>
        <td><asp:TextBox ID="DataPrimiriiTextBox" runat="server" Text='<%# Bind("DataPrimirii","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
            
            </td>
        <td class="heading" >Data prelevarii:</td>
        <td> <asp:TextBox ID="DataPrelevareTextBox" runat="server" Text='<%# Bind("DataPrelevare","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
        ...
        <tr>
        <td class="heading" >Data testarii:</td>
        <td><asp:TextBox ID="DataTestareTextBox" runat="server" Text='<%# Bind("DataTestare","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
        
            </td>
        <td class="heading" >Data testarii finale</td>
        <td> <asp:TextBox ID="DataTestareFinalaTextBox" runat="server" Text='<%# Bind("DataTestareFinala","{0:dd/MM/yyyy}") %>'>
            </asp:TextBox>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetMostra"
         DeleteMethod="DeleteMostra" InsertMethod="InsertMostra" TypeName="MostreFabrica" DataObjectTypeName="MostreFabrica">
        <SelectParameters>
