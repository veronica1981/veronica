...
public partial class SmsList : Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string logname = "TestSmsFerme" + DataSelectie.Text.Trim().Replace(@"/", @"_") + ".txt";
        string smsname = "TestSmsFerme" + DataSelectie.Text.Trim().Replace(@"/", @"_") + ".txt";
        ...
        List<MostreFabrica> mostresms = MostreFabrica.GetMostreSMSTest(datatestare);
