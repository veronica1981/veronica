<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="RaportFCB4" Title="Raport FCB" Codebehind="RaportFCB4.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <table style="width: 800px">
        ...
        <tr>
            <td style="width: 122px">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Small"
                    ForeColor="MediumSeaGreen" Text="Client:"></asp:Label></td>
            <td style="width: 191px">
                 <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="NumeClient" DataValueField="NumeClient" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                 </asp:DropDownList></td>
            <td style="width: 206px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:fccl2ConnectionString %>"
        SelectCommand="SELECT DISTINCT [NumeClient] FROM [MostreTancuri] WHERE ([DataTestareFinala] = @DataTestareFinala) ORDER BY [NumeClient]">
        <SelectParameters>
            <asp:ControlParameter ControlID="TextBox1" Name="DataTestareFinala" PropertyName="Text"
                Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:fccl2ConnectionString %>"
        SelectCommand="SELECT [ID], [Nume] FROM [Semnaturi] ORDER BY [Nume]" ProviderName="<%$ ConnectionStrings:fccl2ConnectionString.ProviderName %>"></asp:SqlDataSource>
    &nbsp;<br />
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetMostreFCB"
        TypeName="MostreFabrica">
        <SelectParameters>
            <asp:Parameter DefaultValue="" Name="datatestare" Type="String" />
            <asp:Parameter DefaultValue="" Name="client" Type="String" />
        </SelectParameters>
